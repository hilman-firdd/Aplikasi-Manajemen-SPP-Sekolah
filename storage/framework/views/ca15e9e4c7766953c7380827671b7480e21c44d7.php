            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-options d-flex justify-content-between">
                        ...
                        <div>
                            <a href="<?php echo e(route('transaksi.export')); ?>" class="btn btn-primary btn-sm ml-2" download="true">Export</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input tandai" name="example-checkbox2" value="<?php echo e($item->id); ?>">
