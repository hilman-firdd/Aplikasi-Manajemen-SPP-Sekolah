                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-switch custom-switch-label-onoff d-flex align-items-center">
                                    <input type="checkbox" id="check" name="peserta" value="1" class="custom-switch-input" <?php echo e(isset($tagihan) ? ($tagihan->wajib_semua == 1 ? 'checked' : '') : 'checked'); ?> >
                                    <label class="custom-switch-btn" for="check"></label>
                                    <p class="mt-3 ms-2">Wajib Semua Siswa</p>
                                </div>
                                <div class="custom-switch custom-switch-label-onoff d-flex align-items-center">
                                    <input type="checkbox" id="check1" name="peserta" value="2" class="custom-switch-input" <?php echo e(isset($tagihan) ? (($tagihan->kelas_id != null) ? 'checked' : '') : ''); ?>>
                                    <label class="custom-switch-btn" for="check1"></label>
                                    <p class="mt-3 ms-2">Hanya Kelas</p>
                                </div>
                                <div class="custom-switch custom-switch-label-onoff d-flex align-items-center">
                                    <input type="checkbox" id="check2" name="peserta" value="3" class="custom-switch-input" <?php echo e(isset($tagihan) ? (($tagihan->kelas_id == null && $tagihan->wajib_semua == null) ? 'checked' : '') : ''); ?>>
