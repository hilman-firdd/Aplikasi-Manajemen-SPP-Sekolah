                    ...
                    <div class="row">
                        <div class="col-9">
                            ...
                            <p>
                                ...
                                Invoice: <span id="invoice">01/SPP/<?php echo e(now()->format('YmdHis')); ?></span>
                            </p>
                        </div>
                        <div class="col-3">
                            <div class="d-flex">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input type="text" class="form-control"
                                            value="<?php echo e($item->created_at->format('d-m-Y')); ?>"></td>
                                    <td><input type="text" class="form-control" id="jumlah-0"
                                            value="<?php echo e($item->siswa->nama); ?>"></td>
                                    <td><input type="text" class="form-control" data-id="0"
                                            value="<?php echo e(($item->tagihan->nama)); ?>"></td>
                                    <td><input type="text" class="form-control" data-id="0"
                                            value="IDR. <?php echo e(format_idr($item->diskon)); ?>"></td>
                                    <td><input type="text" class="form-control" data-id="0"
                                            value="IDR. <?php echo e(format_idr($item->keuangan->jumlah)); ?>"></td>
                                </tr>
                        ...
                        <table class="table card-table table-vcenter text-wrap title">
                            <tr>
                                ...
                                <td style="width: 20%;">IDR. <span id="total"><?php echo e($total); ?></span></td>
                            </tr>
                            <tr>
                                <td style="width: 60%"></td>
...
</html><?php /**PATH C:\laragon\www\spp-app\resources\views/transaksiprint.blade.php ENDPATH**/ ?>