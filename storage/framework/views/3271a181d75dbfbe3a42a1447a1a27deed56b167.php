                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-9">
                            ...
                            <p>Invoice: <span id="invoice"><?php echo e($kuitansi->invoice); ?></span></p>
                        </div>
                        <div class="col-3">
                            <div class="d-flex">
                                <p class="ml-auto">
                                    Tanggal : <?php echo e($kuitansi->created_at->format('d-m-Y')); ?><br>
                        ...
                        <table class="table card-table table-hover table-vcenter text-wrap title" id="print">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 60%">
                                        <input type="text" class="form-control" value="<?php echo e($item->nama); ?>">
                                    </td>
                                    <td><input type="text" class="form-control" id="jumlah-0"
                                            value="<?php echo e($item->jumlah); ?>"></td>
                                    <td><input type="text" class="form-control harga" data-id="0"
                                            value="<?php echo e($item->harga); ?>"></td>
                                </tr>
                        ...
                        <table class="table card-table table-vcenter text-wrap title">
                            <tr>
                                ...
                                <td style="width: 20%;">IDR. <span id="total"><?php echo e($kuitansi->total); ?></span></td>
                            </tr>
                            <tr>
                                <td style="width: 60%"></td>
...
</html><?php /**PATH C:\laragon\www\spp-app\resources\views/admin/kuitansi/print.blade.php ENDPATH**/ ?>