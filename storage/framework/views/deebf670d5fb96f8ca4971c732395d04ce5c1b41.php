<nav class="navbar navbar-expand-lg" id="navbar-sidebar">
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center justify-content-end gap-4">
        ...
        >
          <img
            src="<?php echo e(asset('template/assets/images/ic_search.svg')); ?>"
            width="20px"
            height="20px"
          />
        </button>
        <img
          src="<?php echo e(asset('template/assets/images/avatar.jpg')); ?>"
          alt="Photo Profile"
          class="avatar"
        />
      </div>
    </div>
  </nav><?php /**PATH C:\laragon\www\spp-app\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>