                        ...
                        <table style="border: 1px solid black; width: 100%; padding:5px;">
                            ...
                            <tr>
                                ...
                                <td style="min-width:100px;text-align: left;">
                                    <?php echo e($tabungan->created_at->format('d-m-Y')); ?>

                                </td>
                                <td style="min-width:100px;text-align: left;">
                                    <?php if($tabungan->tipe == 'in'): ?>
                                    Menabung
                                    <?php else: ?>
                                    Penarikan
                                    <?php endif; ?>
                                ...
                                <td style="min-width:100px;text-align: left;">
                                    IDR. <?php echo e(format_idr($tabungan->jumlah)); ?>
...
</html><?php /**PATH C:\laragon\www\spp-app\resources\views/admin/tabungan/tabunganprint.blade.php ENDPATH**/ ?>