                            ...
                            <tr>
                                ...
                                <td style="max-width: 150px">
                                    ...
                                    <?php elseif($item->kelas_id != null): ?>
                                        <p><?php echo e($item->kelas->nama); ?> <?php echo e(isset($item->kelas->periode) ? ' - '.$item->kelas->periode->nama : ''); ?></p>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="<?php echo e(route('tagihan.destroy', $item->id)); ?>" method="POST" id="form-<?php echo e($item->id); ?>">
                                        <?php echo csrf_field(); ?> 
                                    </form>
                                </td>
                            </tr>
