        ...
        <div class="col-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><b>NIK</b> : <?php echo e($siswa->email); ?></p>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options d-flex justify-content-between">
                        ...
                        <div>
                            <a href="<?php echo e(route('tabungan.cetak', $siswa->id)); ?>" target="_blank" class="btn btn-primary mr-1">Cetak</a>
                            <a href="<?php echo e(route('tabungan.siswa.export', $siswa->id)); ?>" target="_blank" class="btn btn-primary">Export</a>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <div class="col-6 col-md-6 mt-3">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-options d-flex justify-content-between">
                        <div>
                            <input class="form-control" type="text" name="dates" style="max-width: 300px" id="daterange" value="<?php echo e(now()->subDay(7)->format('m-d-Y')." - ".now()->format('m-d-Y')); ?>">
                        </div>
                        <div>
