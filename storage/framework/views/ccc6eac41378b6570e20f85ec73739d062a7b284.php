                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-9">
                            ...
                            <h3 style="text-align:center">Bukti Bayar SPP</h3>
                        </div>
                        <div class="col-3">
                            <div class="d-flex">
                                <p class="ml-auto">
                        ...
                        <table style="border: 1px solid black; width: 100%; padding:5px;" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>Rp. <?php echo e($item->keuangan->jumlah); ?></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <th colspan="4">Total</th>
                                <td style="width: 20%;">Rp. <span id="total"><?php echo e($total); ?></span></td>
                            </tr>
                        </table>
...
</html><?php /**PATH C:\laragon\www\spp-app\resources\views/admin/transaksi/transaksiprint.blade.php ENDPATH**/ ?>